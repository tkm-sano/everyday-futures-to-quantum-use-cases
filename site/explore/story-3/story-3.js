const storyScenes = {
  scene1: {
    ...
    aspectRatio: "3 / 2",
    alt: "Sample image for society story moment 1.",
    hotspots: [
  ...
  scene2: {
    ...
    alt: "Sample image for society story moment 2.",
    hotspots: [
  ...
  scene3: {
    ...
    alt: "Sample image for society story moment 3.",
    hotspots: [
  ...
  scene4: {
    ...
    alt: "Sample image for society story moment 4.",
    hotspots: [
